...
import Test.Elwood.Telegram.ToolUse qualified
...
import Test.Elwood.Tools.SendMessage qualified
...
tests =
  testGroup
    ...
    [ Test.Elwood.AgentSettings.tests,
      ...
      Test.Elwood.Tools.SendMessage.tests,
      ...
      Test.Elwood.Telegram.ToolUse.tests,
