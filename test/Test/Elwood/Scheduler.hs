...
import Elwood.Scheduler (isWithinActiveHours, hashJobName)
...
activeHoursTests = testGroup "isWithinActiveHours"
...
hashJobNameTests = testGroup "hashJobName"
...
hashJobNameProperties = testGroup "hashJobName properties"
