...
commandPermissionTests = testGroup "checkCommandPermission"
...
pathPermissionTests = testGroup "checkPathPermission"
...
isAllowedTests = testGroup "isAllowed"
