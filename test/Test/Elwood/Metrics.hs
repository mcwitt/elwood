...
-- | Helper to create a temporary ConversationStore
withTempConvStore :: (ConversationStore -> IO a) -> IO a
withTempConvStore action = do
  tmpDir <- getCanonicalTemporaryDirectory
  dir <- createTempDirectory tmpDir "elwood-metrics-test"
